<div class="sticky top-0 z-50">
	...
	<div class="w-full bg-blue-900 flex justify-between shadow py-2 px-4 md:px-24 lg:px-36 place-self-center">
		<div class="place-self-center z-10">
			<a href="{{route('home')}}" class="font-logo text-white text-2xl flex hover:text-gray-200 transition duration-200 select-none">
		...
		<div class="absolute inset-x-0 justify-center flex place-self-center">
			<svg wire:click="open" class="h-4 cursor-pointer md:hidden fill-current text-white" viewBox="0 0 512.005 512.005" style="enable-background:new 0 0 512.005 512.005;" xml:space="preserve">
